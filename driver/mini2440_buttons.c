...
static struct file_operations dev_fops = {
    .owner   =   THIS_MODULE,
    .open    =   s3c24xx_buttons_open,		//打开
    .release =   s3c24xx_buttons_close, 	//关闭
    .read    =   s3c24xx_buttons_read,		//读
...
static struct miscdevice misc = {
	...
	.name = DEVICE_NAME,			//名字
	.fops = &dev_fops,				//字符设备要file_operation
};

static int __init dev_init(void)	//混杂设备注册 利用次设备号区分
{
	int ret;
